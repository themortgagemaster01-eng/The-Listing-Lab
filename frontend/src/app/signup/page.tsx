...
/**
 * Mirrors `/login`'s shell (same ambient background, card, logo) on purpose
 * — this and `/login` should read as the same product, not two different
 * designs. `LoginForm`/`SignupForm` cross-link to each other.
 */
        ...
        <div className="rounded-3xl border border-border bg-surface/90 p-8 shadow-soft-lg backdrop-blur-sm sm:p-10">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Start marketing your next listing in minutes.
            </p>
          </div>
